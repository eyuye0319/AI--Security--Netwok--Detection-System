...
| :--- | :--- | :--- |
| `GEMINI_API_KEY` | Recommended | Google Gemini API Key for AI Security Specialist analysis. |
| `JWT_SECRET` | Optional | Secret key used to sign and verify JSON Web Tokens. |
| `PORT` | Pre-configured | Server listening port (default: `3000`). |
